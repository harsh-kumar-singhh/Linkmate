...
export function DashboardHeader() {
    ...
    return (
        <header className="h-16 md:h-20 border-b border-white/[0.05] bg-site-bg px-4 md:px-8 flex items-center justify-between sticky top-0 z-40 transition-colors">
