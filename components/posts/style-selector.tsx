    ...
    return (
        <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0 md:w-auto md:flex-none md:min-w-[240px] min-h-[3.5rem] relative overflow-hidden bg-background border border-border/80 rounded-xl flex items-center justify-center group px-8 py-1 shrink-0 transition-all">
                    <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <span className="font-semibold text-sm transition-all duration-300 transform whitespace-normal w-full text-center leading-tight break-words hyphens-auto">
                        {value}
                    </span>
