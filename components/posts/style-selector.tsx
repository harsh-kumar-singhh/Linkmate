    ...
    return (
        <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0 md:w-auto md:flex-none md:min-w-[240px] min-h-[3.5rem] relative overflow-hidden bg-background border border-border/80 rounded-xl flex items-center justify-center group px-10 py-1 shrink-0 transition-all">
